...
class TransferScreenn extends StatefulWidget {
  static const Color primaryTheme = Color.fromRGBO(237, 182, 2, 0.769);

  const TransferScreenn({super.key}); // ✅ Must match const usage in main.dart

  @override
  State<TransferScreenn> createState() => _TransferScreennState();
}

class _TransferScreennState extends State<TransferScreenn> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: TransferScreenn.primaryTheme,
        elevation: 0,
      ),
      body: Container(
